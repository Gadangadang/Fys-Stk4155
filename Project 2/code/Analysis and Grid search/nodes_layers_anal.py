...
if __name__ == "__main__":
    ...
    plot_heatmap(test_scores,[r"Hidden nodes per layers", num_hidden_nodes], ["Hidden layers",num_hidden_layers], title = "Neural network test accuracy for Breast cancer data", name = None)
